...
public class HotelAdditionalServicesController {
	...
	public ResponseEntity<MessageDTO> addAdditionalService(@Valid @RequestBody HotelAdditionalServiceDTO additionalService) {
	...
	public ResponseEntity<MessageDTO> editAdditionalService(@PathVariable("name") String name,
			@Valid @RequestBody HotelAdditionalServiceDTO additionalService) {
