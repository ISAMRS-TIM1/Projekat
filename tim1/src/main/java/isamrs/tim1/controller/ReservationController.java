...
public class ReservationController {
	...
	public ResponseEntity<MessageDTO> reserveQuickFlightReservation(@PathVariable("discountPoints") int discountPoints, @Valid @RequestBody FlightReservationDTO flightRes) {
