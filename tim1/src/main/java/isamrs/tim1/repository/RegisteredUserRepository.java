...
public interface RegisteredUserRepository extends JpaRepository<RegisteredUser, Long> {
	...
	@Query(value = "select * from users u where lower(u.first_name) like ?1 and lower(u.last_name) like ?2 and u.email not like ?3 and dtype like 'RegisteredUser'", nativeQuery = true)
