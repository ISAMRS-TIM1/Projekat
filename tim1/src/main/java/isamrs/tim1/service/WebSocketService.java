...
public class WebSocketService {
	...
	public ResponseEntity<MessageDTO> sendInvitation(String invitedUser) {
		...
		if (invited == null)
			return new ResponseEntity<MessageDTO>(new MessageDTO("User does not exist.", "error"), HttpStatus.OK);
		...
		return new ResponseEntity<MessageDTO>(new MessageDTO("Friend invitation is sent.", "success"), HttpStatus.OK);
	}
}
